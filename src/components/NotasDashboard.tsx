...
import { AlertTriangle, BellRing, Download, Send, Users } from "lucide-react";
...
export function NotasDashboard({ schoolId, classId, className, bimester }: Props) {
  ...
  const summary = useMemo(() => {
    ...
    if (!r) return { atRisk: 0, missingGrades: 0, lowGrade: 0, lowFreq: 0 };
    let missingGrades = 0;
    let lowGrade = 0;
    let lowFreq = 0;
    ...
    return { atRisk: r.totals.atRisk, missingGrades, lowGrade, lowFreq };
  }, [reportQ.data]);
